  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        backgroundColor: Colors.yellow, // Color de fondo del menú inferior
        selectedItemColor:
            Colors.black, // Color de ícono y etiqueta de la opción seleccionada
        unselectedItemColor: Colors
            .grey, // Color de ícono y etiqueta de las opciones no seleccionadas
      ),
    );
  }
}
